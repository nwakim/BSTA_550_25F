...
1. Define key probability and its relationship to randomness. 

2. Use simple simulations (e.g., coin flips in R) to illustrate randomness in equally likely outcomes.

3. Identify sample spaces and events for basic experiments, and define probability calculations. 
