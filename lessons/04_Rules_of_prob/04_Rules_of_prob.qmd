...
3.  Use set process to calculate probability of event of interest

4.  Calculate the probability of an event occurring, given that another event occurred.

5.  Define keys facts for conditional probabilities using notation.

6.  Calculate conditional probability of an event using Bayes' Theorem

7.  Utilize additional probability rules in probability calculations, specifically the Higher Order Multiplication Rule and the Law of Total Probabilities
