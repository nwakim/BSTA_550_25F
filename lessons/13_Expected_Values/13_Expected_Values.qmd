...
2.  Calculate the mean (expected value) of a single discrete RV

3. Calculate expected value for sum of discrete RVs

4. Calculate the mean (expected value) of a single continuous RV

5. Calculate expected value for joint distributions (continuous RV)
