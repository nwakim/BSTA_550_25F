...
|----|----|
| `rhyper()` | returns [sample of random variables]{style="color:#367B79"} with [specified distribution]{style="color:#BF396F"} |
| `dhyper()` | returns [value of probability density]{style="color:#367B79"} at [certain point of the distribution]{style="color:#BF396F"} |
| `phyper()` | returns [cumulative probability]{style="color:#367B79"} of getting [certain point (or less) of the normal distribution]{style="color:#BF396F"} |
| `qhyper()` | returns [inverse CDF]{style="color:#367B79"} corresponding to [desired quantile]{style="color:#BF396F"} |
